...
// If empty / unset, ALL addresses are allowed (open access).
    ...
    Credentials({
      ...
      async authorize(credentials) {
        try {
          ...
          // Passing domain + nonce so the siwe library re-validates them
          // against the message fields as a defense-in-depth measure.
